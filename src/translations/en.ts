export const en = {
  ...
  gameInfoPage: {
    ...
    achievements: 'Achievements',
    points: 'Points',
    hashesCompatible: 'Compatible hashes',
  },
  pieChart: {
    noData: 'No data',
  },
  ...
  gameExpanded: {
    weekly: 'Weekly',
    monthly: 'Monthly',
    achievementsOverTime: 'Achievements unlocked',
    noActivity: 'No achievements unlocked in this period',
    allAchievements: 'All achievements',
    pinnedAchievements: 'Pinned achievements',
    pinAchievementAria: 'Pin an achievement',
    pinAchievementModalTitle: 'Pin an achievement',
    noUnearned: 'No achievements left to pin',
    unpinAria: 'Unpin',
    loadError: 'Could not load pinned achievements',
    points: 'Points',
  ...
  favorites: {
    ...
    emptyTitle: 'No pinned achievements',
  ...
  cards: {
    ...
    almostThereSub: 'Get within 25% of completing a game to see it here',
    ...
    noCompletedGamesSub: 'Master or complete a game to see it here',
    noRarityData: 'No rarity data',
    noRarityDataSub: 'Rare achievement unlocks will appear here',
    noAbandonedGames: 'No abandoned games',
    noAbandonedGamesSub: 'Games idle 30+ days will show up here',
  ...
  steam: {
    ...
    gamesSection: 'Steam',
    gamesError: 'Could not load your Steam games',
    privateProfileHint: 'If your Steam profile is private, set Game details to Public in your Steam privacy settings.',
    noGamesInCategory: 'No Steam games here',
    profileError: 'Could not load your Steam profile',
