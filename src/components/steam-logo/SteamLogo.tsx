/**
 * Steam's official mark (from the logo on Steam's own CDN), where RaLogo
 * sits for RetroAchievements. Drawn in `currentColor`, so callers colour it
 * with text classes. Decorative unless given an `aria-label`.
 */
export default function SteamLogo({
  ...
  return (
    ...
    >
      ...
      <path d="M69.95,33.436c0-6.129-4.986-11.116-11.116-11.116c-6.129,0-11.116,4.987-11.116,11.116c0,6.13,4.987,11.115,11.116,11.115C64.964,44.55,69.95,39.565,69.95,33.436 M50.502,33.417c0-4.612,3.739-8.35,8.351-8.35c4.612,0,8.351,3.738,8.351,8.35s-3.739,8.35-8.351,8.35C54.241,41.767,50.502,38.028,50.502,33.417" />
    </svg>
  )
}
