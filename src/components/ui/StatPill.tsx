export function StatPill({
  ...
  if (size === 'sm') {
    return (
      <div className={`bg-bg-main rounded-xl p-2 flex flex-col items-center gap-0.5 ${className}`}>
  ...
  return (
    <div className={`bg-bg-main rounded-xl px-5 py-3 flex flex-col gap-0.5 flex-1 min-w-30 ${className}`}>
